...
- [update-progress](/commands/update-progress): Updates the implementation status document with newly completed work from the current conversation. Meant to compound architectural knowledge.
- [merge-without-pr](/commands/merge-without-pr): Merge worktree to main directly via rebase and fast-forward.
