...
- [update-progress](/commands/update-progress.md): Updates the implementation status document with newly completed work from the current conversation. Meant to compound architectural knowledge.
